...
class GojekWelcomePage2 extends StatelessWidget {
  const GojekWelcomePage2({super.key});
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/gojek_logo.png', // Replace with your asset
                        height: 30,
                      ),
                      Text(
                        'IND',
                  ...
                  SizedBox(height: 160),
                  Image.asset(
                    'assets/onboarding_transportasi.png',
                  ),
                  SizedBox(height: 20),
                  Text(
